        ...
        <div className="grid lg:grid-cols-[1fr_auto_1fr] gap-10 lg:gap-8 items-center">
          ...
          <ScrollReveal variant="scale" delay={0.2} className="hidden lg:block">
            <div className="relative">
              ...
              <motion.div
                className="absolute -top-6 -right-6 w-12 h-12 border-t-2 border-r-2 border-primary/40"
                animate={{ opacity: [0.4, 1, 0.4] }}
                transition={{ duration: 3, repeat: Infinity }}
              />
              <motion.div
                className="absolute -bottom-6 -left-6 w-12 h-12 border-b-2 border-l-2 border-accent/40"
                animate={{ opacity: [0.4, 1, 0.4] }}
              ...
              {/* Vertical text */}
              <motion.p
                className="absolute -right-10 top-1/2 -translate-y-1/2 text-[10px] font-mono uppercase tracking-[0.4em] text-muted-foreground/40 [writing-mode:vertical-lr]"
