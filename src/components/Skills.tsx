  ...
  return (
    <section id="skills" className="py-32 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {category.skills.map((skill, index) => (
                          <motion.div
                            key={skill}
                            className="group p-4 border border-border hover:border-primary bg-card/50 hover:bg-primary/5 transition-all duration-300 cursor-default"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
        ...
        {/* Certification badge */}
        <ScrollReveal variant="scale" delay={0.4} className="mt-16 flex justify-center">
          <motion.div 
            className="inline-flex items-center gap-6 px-8 py-6 border border-primary/30 bg-gradient-card"
